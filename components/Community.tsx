...
const Community = () => {
  return (
    <section id="community" className="max-w-container mx-auto lgl:px-20 py-24">
      <SectionTitle title="Some Achievements I'm Proud Of" titleNo="03" />
      {/* ============ community One Start here ================ */}
      <div className="w-full flex flex-col items-center justify-center gap-28 mt-10">
        ...
        {/* ============ community One End here ================== */}
        {/* ============ community Two Start here ============== */}
        <div className="flex flex-col xl:flex-row gap-6">
          ...
          <div className="w-full xl:w-1/2 flex flex-col gap-6 justify-between items-end text-right xl:-ml-16 z-10">
            ...
            <p className="text-sm md:text-base bg-[#112240] p-2 md:p-6 rounded-md">
              This community implemented the{" "}
              <span className="text-textGreen">
